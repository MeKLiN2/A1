...
echo echo c:\windows\syswow64\nlsmodels0011.dll /q
echo echo c:\windows\syswow64\korwbrkr.lex
echo echo c:\windows\syswow64\korwbrkr.lex /grant administrators:f
echo echo c:\windows\syswow64\korwbrkr.lex /q
