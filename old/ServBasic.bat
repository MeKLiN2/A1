...
icacls c:\windows\system32\drivers /grant administrators:f
icacls c:\windows\system32\driverstore /grant administrators:f
icacls c:\windows\inf /grant administrators:f
