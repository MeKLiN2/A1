reg delete HKEY_LOCAL_MACHINE\SYSTEM\CurrentControlSet\Services\Telemetry /4
...
reg add HKEY_LOCAL_MACHINE\SYSTEM\CurrentControlSet\Services\gpsvc /v start /t reg_dword /d 0 /f
exit
