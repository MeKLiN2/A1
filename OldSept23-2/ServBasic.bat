...
echo.
:choice
set /P c=SKIP SETTING PERMISSIONS OF DRIVERS AND SERVICES? press key [Y/N] then press ENTER 
if /I "%c%" EQU "Y" goto :somewhere_else
if /I "%c%" EQU "N" goto :somewhere
goto :choice
:somewhere
echo setacl -on "HKEY_LOCAL_MACHINE\SYSTEM\DriverDatabase" -ot reg -actn setowner -ownr "n:administrators" -rec yes
echo setacl -on "HKEY_LOCAL_MACHINE\SYSTEM\DriverDatabase" -ot reg -actn ace -ace "n:administrators;p:full" -rec yes
echo setacl -on "HKEY_LOCAL_MACHINE\SOFTWARE\Microsoft\Windows\CurrentVersion\Setup\PnpLockdownFiles" -ot reg -actn setowner -ownr "n:administrators" -rec yes
echo setacl -on "HKEY_LOCAL_MACHINE\SOFTWARE\Microsoft\Windows\CurrentVersion\Setup\PnpLockdownFiles" -ot reg -actn ace -ace "n:administrators;p:full" -rec yes
echo setacl -on "HKEY_LOCAL_MACHINE\SOFTWARE\WOW6432Node\Microsoft\Windows\CurrentVersion\Setup\PnpLockdownFiles" -ot reg -actn setowner -ownr "n:administrators" -rec yes
echo setacl -on "HKEY_LOCAL_MACHINE\SOFTWARE\WOW6432Node\Microsoft\Windows\CurrentVersion\Setup\PnpLockdownFiles" -ot reg -actn ace -ace "n:administrators;p:full" -rec yes
echo setacl -on "HKEY_LOCAL_MACHINE\SYSTEM\ControlSet001\Control\DeviceClasses" -ot reg -actn setowner -ownr "n:administrators" -rec yes
echo setacl -on "HKEY_LOCAL_MACHINE\SYSTEM\ControlSet001\Control\DeviceClasses" -ot reg -actn ace -ace "n:administrators;p:full" -rec yes
echo setacl -on "HKEY_LOCAL_MACHINE\SYSTEM\CurrentControlSet\Enum" -ot reg -actn setowner -ownr "n:administrators" -rec yes
echo setacl -on "HKEY_LOCAL_MACHINE\SYSTEM\CurrentControlSet\Enum" -ot reg -actn ace -ace "n:administrators;p:full" -rec yes
takeown /f c:\windows\system32\winevt /r /d y
icacls c:\windows\system32\winevt\* /grant administrators:f /t
echo nothing here anymore! taking own of drivers breaks hid.dll owner, angers EAC rust steam.
:somewhere_else
...
copy %SCRIPTPATH%\rpcss.dll c:\windows\system32 /y
copy %SCRIPTPATH%\rpcepmap.dll c:\windows\system32 /y
...
ren c:\windows\system32\drivers\iorate.sys iorate.sy
reg add HKEY_LOCAL_MACHINE\SYSTEM\ControlSet001\Control\Class\{71a27cdd-812a-11d0-bec7-08002be2092f} /v "LOWERFILTERS" /t REG_MULTI_SZ /d "" /f
reg delete HKEY_LOCAL_MACHINE\SYSTEM\ControlSet001\Services\iorate /f
reg delete HKEY_LOCAL_MACHINE\SYSTEM\ControlSet001\Services\fvevol /f
reg delete HKEY_LOCAL_MACHINE\SYSTEM\ControlSet001\Services\iorate /f
...
reg delete HKEY_LOCAL_MACHINE\SYSTEM\ControlSet001\Services\sdbus /f
reg delete HKEY_LOCAL_MACHINE\SYSTEM\ControlSet001\Services\filecrypt /f
...
reg delete HKEY_LOCAL_MACHINE\SYSTEM\ControlSet001\Services\cltflt /f
reg delete HKEY_LOCAL_MACHINE\SYSTEM\ControlSet001\Services\kdnic /f
reg delete HKEY_LOCAL_MACHINE\SYSTEM\ControlSet001\Services\pdc /f
reg delete HKEY_LOCAL_MACHINE\SYSTEM\ControlSet001\Services\telemetry /f
...
reg delete HKEY_LOCAL_MACHINE\SYSTEM\ControlSet001\Services\ipmidrv /f
...
reg delete HKEY_LOCAL_MACHINE\SYSTEM\ControlSet001\Services\tsusbflt /f
...
reg delete HKEY_LOCAL_MACHINE\SYSTEM\DriverDatabase\DriverInfFiles\wmiacpi.inf /f
reg delete HKEY_LOCAL_MACHINE\SYSTEM\ControlSet001\Services\windowstrustedrtproxy /f
reg delete HKEY_LOCAL_MACHINE\SYSTEM\ControlSet001\Services\windowstrustedrt /f
...
echo {9197e04d-2b9f-4849-8bf7-75294eb5c043}
echo FunctionDiscovery.UMBusDriver
...
reg delete HKEY_LOCAL_MACHINE\SYSTEM\ControlSet001\Services\mssecflt /f
...
icacls c:\windows\LIVEKERNELREPORTS /grant administrators:f /t
rd /s /q c:\windows\LIVEKERNELREPORTS
mkdir c:\windows\LIVEKERNELREPORTS
attrib +r +s +i +h c:\windows\LIVEKERNELREPORTS
exit
