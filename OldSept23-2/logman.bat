...
c:\windows\system32\logman stop "Microsoft-Windows-Rdp-Graphics-RdpIdd-Trace Trace" -ets
c:\windows\system32\logman stop "SHS-07092022-024750-7-3f" -ETS
c:\windows\system32\logman stop "MpWppTracing-20220709-024352-00000003-ffffffff" -ets
c:\windows\system32\logman stop Diagtrack-Listener -ets
c:\windows\system32\logman stop Admin_PS_Provider -ets
c:\windows\system32\logman stop RzPresentMon -ets   
EXIT
