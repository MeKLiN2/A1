...
echo.
:choice
set /P c=Do you want to remove the windows watermark with Nefarius' injector(command line exe) and NoDesktopWM_Revamped(desktop.dll injected into explorer.exe)?[Y/N]?
