...
icacls c:\windows\system32\logfiles /grant system:f /t
icacls c:\windows\system32\logfiles /grant administrator:f /t
icacls c:\windows\system32\logfiles /grant administrators:f /t
mkdir c:\ZTEMP
mkdir c:\01DOC
mkdir c:\02DESK
mkdir c:\ZVOID
mkdir C:\USERS\administrator\AppData\Local\Microsoft\Windows\Explorer
mkdir C:\USERS\administrator\AppData\Local\Microsoft\Windows\Notifications
robocopy c:\users\default c:\windows\system32\config\systemprofile /e /copyall /xj /r:1 /w:1
mkdir C:\USERS\administrator\AppData\Local\Packages\Microsoft.Messaging_8wekyb3d8bbwe
...
attrib +r +s +h C:\USERS\administrator\AppData\Local\Packages\Microsoft.Windows.Cortana_cw5n1h2txyewy
mkdir C:\USERS\administrator\AppData\Local\Packages\Microsoft.Windows.Photos_8wekyb3d8bbwe
mkdir C:\Users\Default\AppData\Local\Microsoft\Windows\Explorer
mkdir C:\Windows\System32\LogFiles\SQM
mkdir C:\Windows\system32\LogFiles\Mlnx
mkdir c:\windows\system32\wfp\
mkdir C:\Windows\System32\LogFiles\AIT
mkdir C:\windows\winsxs\temp\logfiles
mkdir C:\ProgramData\Microsoft\Diagnosis\TenantStorage\P-ARIA
mkdir c:\users\administrator\CONNECTEDDEVICESPLATFORM
...
rd /s /q C:\USERS\administrator\desktop
rd /s /q C:\USERS\administrator\desktop
mklink /j C:\USERS\administrator\desktop c:\02DESK
mklink /j C:\USERS\administrator\documents c:\01DOC
...
ren c:\windows\system32\upfc.exe upfc.ex
ren c:\windows\syswow64\upfc.exe upfc.ex
rd /s /q c:\users\administrator\microsoftedgebackups
...
rd /s /q C:\windows\system32\config\systemprofile\DESKTOP C:\USERS\administrator\DESKTOP
rd /s /q C:\windows\system32\config\systemprofile\DOCUMENTS C:\USERS\administrator\DOCUMENTS
rd /s /q C:\windows\syswow64\config\systemprofile\DESKTOP C:\USERS\administrator\DESKTOP
rd /s /q C:\windows\syswow64\config\systemprofile\DOCUMENTS C:\USERS\administrator\DOCUMENTS
...
echo                         [Sept. 1 2022: MEANT TO BE RUN ON C:\  ]  youtube.com/indicator27
